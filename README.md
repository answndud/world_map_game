...
- 브라우저 스모크 테스트
  - `./gradlew browserSmokeTest`로 `home`, `capital start -> play`, `recommendation survey -> result`, `/ranking`, `/stats`를 실제 Chromium에서 검증
