...
@Entity
@Table(name = "population_battle_game_session")
public class PopulationBattleGameSession extends BaseGameSession {
	...
	protected PopulationBattleGameSession() {
	}

	private PopulationBattleGameSession(
		UUID id,
	...
	public static PopulationBattleGameSession ready(String playerNickname, Integer totalRounds) {
		return new PopulationBattleGameSession(UUID.randomUUID(), playerNickname, null, null, totalRounds);
	}

	public static PopulationBattleGameSession ready(
		String playerNickname,
		Long memberId,
		String guestSessionKey,
		Integer totalRounds
	) {
		return new PopulationBattleGameSession(UUID.randomUUID(), playerNickname, memberId, guestSessionKey, totalRounds);
	}
