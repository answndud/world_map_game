...
@Entity
@Table(name = "flag_game_session")
public class FlagGameSession extends BaseGameSession {
	...
	protected FlagGameSession() {
	}

	private FlagGameSession(
		UUID id,
	...
	public static FlagGameSession ready(String playerNickname, Integer totalRounds) {
		return new FlagGameSession(UUID.randomUUID(), playerNickname, null, null, totalRounds);
	}

	public static FlagGameSession ready(
		String playerNickname,
		Long memberId,
		String guestSessionKey,
		Integer totalRounds
	) {
		return new FlagGameSession(UUID.randomUUID(), playerNickname, memberId, guestSessionKey, totalRounds);
	}
