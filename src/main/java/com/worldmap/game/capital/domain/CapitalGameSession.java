...
@Entity
@Table(name = "capital_game_session")
public class CapitalGameSession extends BaseGameSession {
	...
	protected CapitalGameSession() {
	}

	private CapitalGameSession(
		UUID id,
	...
	public static CapitalGameSession ready(String playerNickname, Integer totalRounds) {
		return new CapitalGameSession(UUID.randomUUID(), playerNickname, null, null, totalRounds);
	}

	public static CapitalGameSession ready(
		String playerNickname,
		Long memberId,
		String guestSessionKey,
		Integer totalRounds
	) {
		return new CapitalGameSession(UUID.randomUUID(), playerNickname, memberId, guestSessionKey, totalRounds);
	}
