...
- 세 번째 retained runtime으로 [population-game.js](/Users/alex/project/worldmap/demo-lite/src/features/population-game.js)를 열어 `population scale band 4-choice`, `같은 문제 재시도`, `5 rounds + 3 lives + localStorage best score` 루프를 브라우저 메모리 상태로 붙였다
- 네 번째 retained runtime으로 [population-battle-game.js](/Users/alex/project/worldmap/demo-lite/src/features/population-battle-game.js)를 열어 `population rank gap 기반 pair`, `difficulty band`, `2-choice battle`, `같은 문제 재시도` 루프를 브라우저 메모리 상태로 붙였다
