...
| --- | --- | --- |
| Java runtime | `eclipse-temurin:25-jre` | [Dockerfile.local](../Dockerfile.local) |
| build image | `eclipse-temurin:25-jdk` | [Dockerfile.local](../Dockerfile.local) |
| app user | `spring` / `uid=10001` | [Dockerfile.local](../Dockerfile.local) |
| container port | `8080` | [Dockerfile.local](../Dockerfile.local), [task-definition.prod.sample.json](../deploy/ecs/task-definition.prod.sample.json) |
| stop signal | `SIGTERM` | [Dockerfile.local](../Dockerfile.local) |
| JVM opt default | `-XX:MaxRAMPercentage=75.0` | [Dockerfile.local](../Dockerfile.local), [task-definition.prod.sample.json](../deploy/ecs/task-definition.prod.sample.json) |
...
[Dockerfile.local](../Dockerfile.local) 구조:
