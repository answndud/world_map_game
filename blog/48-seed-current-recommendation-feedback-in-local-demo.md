...
> 현재 저장소 재현 기준 버전은 `survey-v4 / engine-v13`이고, 최신 기준은 [50-current-state-rebuild-map.md](./50-current-state-rebuild-map.md), [53-reduce-p06-anchor-drift-with-practical-public-value-bonus.md](./53-reduce-p06-anchor-drift-with-practical-public-value-bonus.md), [LOCAL_DEMO_BOOTSTRAP.md](/Users/alex/project/worldmap/docs/LOCAL_DEMO_BOOTSTRAP.md)를 본다.
...
현재 `survey-v4 / engine-v13` 추천 만족도 샘플도 같이 넣도록 유지하고 있습니다.
...
- [DemoBootstrapIntegrationTest.java](/Users/alex/project/worldmap/src/test/java/com/worldmap/demo/DemoBootstrapIntegrationTest.java)
  - current `survey-v4 / engine-v13` 피드백 5개 이상 생성 확인
