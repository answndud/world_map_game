---
name: design-coinbase-style
description: Apply a Coinbase-inspired visual system for landing pages and product UI with a blue/white financial-tech aesthetic, pill CTAs, and restrained layout rules.
---
